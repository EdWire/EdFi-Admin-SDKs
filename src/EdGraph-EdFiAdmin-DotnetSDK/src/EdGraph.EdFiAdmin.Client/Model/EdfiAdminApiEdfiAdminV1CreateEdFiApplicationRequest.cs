...
namespace EdGraph.EdFiAdmin.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EdfiAdminApi.EdfiAdmin.V1.CreateEdFiApplicationRequest")]
    public partial class EdfiAdminApiEdfiAdminV1CreateEdFiApplicationRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdfiAdminApiEdfiAdminV1CreateEdFiApplicationRequest" /> class.
        /// </summary>
        ...
        public EdfiAdminApiEdfiAdminV1CreateEdFiApplicationRequest(string tenantId = default(string), string instanceId = default(string), int applicationId = default(int), string applicationName = default(string), string claimSetName = default(string), string operationalContextUri = default(string), int vendorId = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdfiAdminApiEdfiAdminV1CreateEdFiApplicationRequest {\n");
