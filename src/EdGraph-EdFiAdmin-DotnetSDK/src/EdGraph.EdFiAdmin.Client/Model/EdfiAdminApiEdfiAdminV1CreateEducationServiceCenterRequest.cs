...
namespace EdGraph.EdFiAdmin.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EdfiAdminApi.EdfiAdmin.V1.CreateEducationServiceCenterRequest")]
    public partial class EdfiAdminApiEdfiAdminV1CreateEducationServiceCenterRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdfiAdminApiEdfiAdminV1CreateEducationServiceCenterRequest" /> class.
        /// </summary>
        ...
        public EdfiAdminApiEdfiAdminV1CreateEducationServiceCenterRequest(string tenantId = default(string), string instanceId = default(string), int educationServiceCenterId = default(int), string nameOfInstitution = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdfiAdminApiEdfiAdminV1CreateEducationServiceCenterRequest {\n");
