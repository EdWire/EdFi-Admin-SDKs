...
namespace EdGraph.EdFiAdmin.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EdfiAdminApi.EdfiAdmin.V1.StudentsByProgramReportResponse")]
    public partial class EdfiAdminApiEdfiAdminV1StudentsByProgramReportResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdfiAdminApiEdfiAdminV1StudentsByProgramReportResponse" /> class.
        /// </summary>
        ...
        public EdfiAdminApiEdfiAdminV1StudentsByProgramReportResponse(string tenantId = default(string), string instanceId = default(string), int localEducationAgencyId = default(int), string localEducationAgencyName = default(string), int totalStudentCount = default(int))
        {
        ...
        /// <summary>
        /// Gets or Sets StudentProgramRepresentations
        /// </summary>
        [DataMember(Name = "studentProgramRepresentations", EmitDefaultValue = true)]
        public List<EdfiAdminApiEdfiAdminV1StudentProgramRepresentation> StudentProgramRepresentations { get; private set; }

        /// <summary>
        /// Returns false as StudentProgramRepresentations should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeStudentProgramRepresentations()
        {
            return false;
        }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdfiAdminApiEdfiAdminV1StudentsByProgramReportResponse {\n");
            ...
            sb.Append("  StudentProgramRepresentations: ").Append(StudentProgramRepresentations).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
