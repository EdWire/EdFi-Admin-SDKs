...
namespace EdGraph.EdFiAdmin.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EdfiAdminApi.EdfiAdmin.V1.EdFiApplicationCreatedResponse")]
    public partial class EdfiAdminApiEdfiAdminV1EdFiApplicationCreatedResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdfiAdminApiEdfiAdminV1EdFiApplicationCreatedResponse" /> class.
        /// </summary>
        ...
        public EdfiAdminApiEdfiAdminV1EdFiApplicationCreatedResponse(string tenantId = default(string), string instanceId = default(string), int applicationId = default(int), string applicationName = default(string), string claimSetName = default(string), string operationalContextUri = default(string), int vendorId = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdfiAdminApiEdfiAdminV1EdFiApplicationCreatedResponse {\n");
