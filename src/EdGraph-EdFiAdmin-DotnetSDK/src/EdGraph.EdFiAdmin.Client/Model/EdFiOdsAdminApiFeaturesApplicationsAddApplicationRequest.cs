...
namespace EdGraph.EdFiAdmin.Client.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiOdsAdminApiFeaturesApplicationsAddApplicationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiOdsAdminApiFeaturesApplicationsAddApplicationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiOdsAdminApiFeaturesApplicationsAddApplicationRequest" /> class.
        /// </summary>
        ...
        public EdFiOdsAdminApiFeaturesApplicationsAddApplicationRequest(string applicationName = default(string), int vendorId = default(int), string claimSetName = default(string), int? profileId = default(int?), List<int> educationOrganizationIds = default(List<int>))
        {
            // to ensure "applicationName" is required (not null)
            if (applicationName == null)
            {
                throw new ArgumentNullException("applicationName is a required property for EdFiOdsAdminApiFeaturesApplicationsAddApplicationRequest and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("claimSetName is a required property for EdFiOdsAdminApiFeaturesApplicationsAddApplicationRequest and cannot be null");
            }
            this.ClaimSetName = claimSetName;
            // to ensure "educationOrganizationIds" is required (not null)
            if (educationOrganizationIds == null)
            {
                throw new ArgumentNullException("educationOrganizationIds is a required property for EdFiOdsAdminApiFeaturesApplicationsAddApplicationRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiOdsAdminApiFeaturesApplicationsAddApplicationRequest {\n");
        ...
        {
            return this.Equals(input as EdFiOdsAdminApiFeaturesApplicationsAddApplicationRequest);
        }

        /// <summary>
        /// Returns true if EdFiOdsAdminApiFeaturesApplicationsAddApplicationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiOdsAdminApiFeaturesApplicationsAddApplicationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiOdsAdminApiFeaturesApplicationsAddApplicationRequest input)
        {
            if (input == null)
            {
                return false;
