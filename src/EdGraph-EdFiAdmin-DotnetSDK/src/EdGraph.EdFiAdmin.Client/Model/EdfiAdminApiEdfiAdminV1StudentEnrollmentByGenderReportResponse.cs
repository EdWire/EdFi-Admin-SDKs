...
namespace EdGraph.EdFiAdmin.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EdfiAdminApi.EdfiAdmin.V1.StudentEnrollmentByGenderReportResponse")]
    public partial class EdfiAdminApiEdfiAdminV1StudentEnrollmentByGenderReportResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdfiAdminApiEdfiAdminV1StudentEnrollmentByGenderReportResponse" /> class.
        /// </summary>
        ...
        public EdfiAdminApiEdfiAdminV1StudentEnrollmentByGenderReportResponse(string tenantId = default(string), string instanceId = default(string), int localEducationAgencyId = default(int), string localEducationAgencyName = default(string), int totalStudentCount = default(int))
        {
        ...
        /// <summary>
        /// Gets or Sets GenderRepresentation
        /// </summary>
        [DataMember(Name = "genderRepresentation", EmitDefaultValue = true)]
        public List<EdfiAdminApiEdfiAdminV1GenderRepresentation> GenderRepresentation { get; private set; }

        /// <summary>
        /// Returns false as GenderRepresentation should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeGenderRepresentation()
        {
            return false;
        }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdfiAdminApiEdfiAdminV1StudentEnrollmentByGenderReportResponse {\n");
            ...
            sb.Append("  GenderRepresentation: ").Append(GenderRepresentation).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
