...
namespace EdGraph.EdFiAdmin.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EdfiAdminApi.EdfiAdmin.V1.CreateStateEducationAgencyRequest")]
    public partial class EdfiAdminApiEdfiAdminV1CreateStateEducationAgencyRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdfiAdminApiEdfiAdminV1CreateStateEducationAgencyRequest" /> class.
        /// </summary>
        ...
        public EdfiAdminApiEdfiAdminV1CreateStateEducationAgencyRequest(string tenantId = default(string), string instanceId = default(string), int stateEducationAgencyId = default(int), string nameOfInstitution = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdfiAdminApiEdfiAdminV1CreateStateEducationAgencyRequest {\n");
