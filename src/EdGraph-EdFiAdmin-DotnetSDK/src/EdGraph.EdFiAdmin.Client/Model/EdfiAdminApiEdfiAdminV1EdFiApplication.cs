...
namespace EdGraph.EdFiAdmin.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EdfiAdminApi.EdfiAdmin.V1.EdFiApplication")]
    public partial class EdfiAdminApiEdfiAdminV1EdFiApplication : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdfiAdminApiEdfiAdminV1EdFiApplication" /> class.
        /// </summary>
        ...
        public EdfiAdminApiEdfiAdminV1EdFiApplication(string tenantId = default(string), int applicationId = default(int), string applicationName = default(string), string claimSetName = default(string), string operationalContextUri = default(string), int vendorId = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdfiAdminApiEdfiAdminV1EdFiApplication {\n");
