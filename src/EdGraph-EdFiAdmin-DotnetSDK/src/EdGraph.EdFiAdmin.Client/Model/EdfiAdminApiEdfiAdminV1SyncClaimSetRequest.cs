...
namespace EdGraph.EdFiAdmin.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EdfiAdminApi.EdfiAdmin.V1.SyncClaimSetRequest")]
    public partial class EdfiAdminApiEdfiAdminV1SyncClaimSetRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdfiAdminApiEdfiAdminV1SyncClaimSetRequest" /> class.
        /// </summary>
        /// <param name="tenantId">tenantId.</param>
        /// <param name="instanceId">instanceId.</param>
        /// <param name="year">year.</param>
        /// <param name="claimSetId">claimSetId.</param>
        public EdfiAdminApiEdfiAdminV1SyncClaimSetRequest(string tenantId = default(string), string instanceId = default(string), int? year = default(int?), int claimSetId = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdfiAdminApiEdfiAdminV1SyncClaimSetRequest {\n");
