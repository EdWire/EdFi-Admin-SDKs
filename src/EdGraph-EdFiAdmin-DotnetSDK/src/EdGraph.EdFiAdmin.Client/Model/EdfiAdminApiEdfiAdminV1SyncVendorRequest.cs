...
namespace EdGraph.EdFiAdmin.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EdfiAdminApi.EdfiAdmin.V1.SyncVendorRequest")]
    public partial class EdfiAdminApiEdfiAdminV1SyncVendorRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdfiAdminApiEdfiAdminV1SyncVendorRequest" /> class.
        /// </summary>
        /// <param name="tenantId">tenantId.</param>
        /// <param name="instanceId">instanceId.</param>
        /// <param name="year">year.</param>
        /// <param name="vendorId">vendorId.</param>
        public EdfiAdminApiEdfiAdminV1SyncVendorRequest(string tenantId = default(string), string instanceId = default(string), int? year = default(int?), int vendorId = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdfiAdminApiEdfiAdminV1SyncVendorRequest {\n");
