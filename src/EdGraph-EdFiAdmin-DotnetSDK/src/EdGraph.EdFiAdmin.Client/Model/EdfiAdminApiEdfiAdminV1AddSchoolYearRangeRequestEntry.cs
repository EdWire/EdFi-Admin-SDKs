...
namespace EdGraph.EdFiAdmin.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EdfiAdminApi.EdfiAdmin.V1.AddSchoolYearRangeRequestEntry")]
    public partial class EdfiAdminApiEdfiAdminV1AddSchoolYearRangeRequestEntry : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdfiAdminApiEdfiAdminV1AddSchoolYearRangeRequestEntry" /> class.
        /// </summary>
        /// <param name="year">year.</param>
        /// <param name="selectedTierId">selectedTierId.</param>
        /// <param name="odsBackupCode">odsBackupCode.</param>
        public EdfiAdminApiEdfiAdminV1AddSchoolYearRangeRequestEntry(int year = default(int), string selectedTierId = default(string), string odsBackupCode = default(string))
        {
            this.Year = year;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdfiAdminApiEdfiAdminV1AddSchoolYearRangeRequestEntry {\n");
